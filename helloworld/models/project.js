 ...
 * [Helloworld.Models.Project.static.findAll retrieving],
 * [Helloworld.Models.Project.static.update updating],
 * [Helloworld.Models.Project.static.destroy destroying], and
 * [Helloworld.Models.Project.static.create creating] projects.
 */
$.Model.extend('Helloworld.Models.Project',
/* @Static */
{
	/**
	...
	findAll: function( params, success, error ){
		$.ajax({
			...
			error: error,
			fixture: "//helloworld/fixtures/projects.json.get" //calculates the fixture path from the url and type.
		});
	},
	/**
